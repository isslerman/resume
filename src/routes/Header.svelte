...
<!-- navbar -->
<nav id="header" class="w-full z-30 bg-white border-b border-gray-400">
	<div class="w-full flex items-center justify-between mt-0 px-6 pt-3">
